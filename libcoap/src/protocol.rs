use libcoap_sys::{
    ...
    coap_request_t, COAP_MEDIATYPE_ANY, COAP_MEDIATYPE_APPLICATION_CBOR, COAP_MEDIATYPE_APPLICATION_COSE_ENCRYPT,
...
use crate::error::{MessageCodeConversionError, UnknownOptionError};
