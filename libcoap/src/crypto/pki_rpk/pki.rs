...
use libcoap_sys::{coap_dtls_key_t, coap_dtls_key_t__bindgen_ty_1, coap_pki_define_t, coap_pki_key_define_t, coap_pki_key_t};
...
impl<CA: KeyComponent<Pki>, PK: KeyComponent<Pki>, SK: KeyComponent<Pki>> PkiKeyDef<CA, PK, SK> {
    pub fn new(ca_cert: CA, public_cert: PK, private_key: SK, user_pin: Option<CString>, asn1_private_key_type: Asn1PrivateKeyType) -> Self {
        Self {
            ca_cert,
            public_cert,
            private_key,
...
impl PkiKeyDef<PemFileKeyComponent, PemFileKeyComponent, PemFileKeyComponent> {
    pub fn with_pem_files(ca_cert: impl Into<PemFileKeyComponent>, public_cert: impl Into<PemFileKeyComponent>, private_key: impl Into<PemFileKeyComponent>) -> Self {
        Self::new(ca_cert.into(), public_cert.into(), private_key.into(), None, Asn1PrivateKeyType::None)
    }
}

impl PkiKeyDef<PemMemoryKeyComponent, PemMemoryKeyComponent, PemMemoryKeyComponent> {
    pub fn with_pem_memory(ca_cert: impl Into<PemMemoryKeyComponent>, public_cert: impl Into<PemMemoryKeyComponent>, private_key: impl Into<PemMemoryKeyComponent>) -> Self {
        Self::new(ca_cert.into(), public_cert.into(), private_key.into(), None, Asn1PrivateKeyType::None)
    }
}

impl PkiKeyDef<DerFileKeyComponent, DerFileKeyComponent, DerFileKeyComponent> {
    pub fn with_asn1_files(ca_cert: impl Into<DerFileKeyComponent>, public_cert: impl Into<DerFileKeyComponent>, private_key: impl Into<DerFileKeyComponent>, private_key_type: Asn1PrivateKeyType) -> Self {
        Self::new(ca_cert.into(), public_cert.into(), private_key.into(), None, private_key_type)
    }
}

impl PkiKeyDef<DerMemoryKeyComponent, DerMemoryKeyComponent, DerMemoryKeyComponent> {
    pub fn with_asn1_memory(ca_cert: impl Into<DerMemoryKeyComponent>, public_cert: impl Into<DerMemoryKeyComponent>, private_key: impl Into<DerMemoryKeyComponent>, private_key_type: Asn1PrivateKeyType) -> Self {
        Self::new(ca_cert.into(), public_cert.into(), private_key.into(), None, private_key_type)
    }
}

impl PkiKeyDef<Pkcs11KeyComponent, Pkcs11KeyComponent, Pkcs11KeyComponent> {
    pub fn with_pkcs11(ca_cert: impl Into<Pkcs11KeyComponent>, public_cert: impl Into<Pkcs11KeyComponent>, private_key: impl Into<Pkcs11KeyComponent>, user_pin: Option<CString>) -> Self {
        Self::new(ca_cert.into(), public_cert.into(), private_key.into(), user_pin, Asn1PrivateKeyType::None)
    }
}
...
impl<CA: KeyComponent<Pki>, PK: KeyComponent<Pki>, SK: KeyComponent<Pki>> KeyDefSealed for PkiKeyDef<CA, PK, SK> {
    ...
    fn as_raw_dtls_key(&self) -> coap_dtls_key_t {
        let (ca, ca_len) = self.ca_cert.as_raw_key_component();
